...
public class DienThoaiActivity extends AppCompatActivity {
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                //add null
                list.add(null);
                dienThoaiAdapter.notifyItemInserted(list.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                dienThoaiAdapter.notifyItemRemoved(list.size());
                page=page+1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if(sanPhamMoiModel.isSuccess()){
                                if(dienThoaiAdapter==null) {
                                    ...
                                    dienThoaiAdapter.notifyItemRangeChanged(vitri,soluongdd);
                                }
                            }else{
    ...
    public void init(){
        ...
        recyclerView=findViewById(R.id.recycleviewd_dt);
