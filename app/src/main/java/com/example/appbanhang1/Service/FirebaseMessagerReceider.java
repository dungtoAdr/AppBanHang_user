package com.example.appbanhang1.Service;
...
import com.example.appbanhang1.activity.MainActivity;

public class FirebaseMessagerReceider extends FirebaseMessagingService {
    @Override
    ...
    private RemoteViews customView(String title, String body){
        ...
        remoteViews.setImageViewResource(R.id.imgnoti,R.drawable.baseline_phone_android_24);
        return  remoteViews;
    }
}
